...
export default function Chat() {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 space-y-4 overflow-y-auto pt-20 pb-20 md:pt-16">
        <AnimatePresence>
          {messages.map((message) => (
            ...
            >
              ...
              >
                <div
                  className={`flex h-10 w-12 items-center justify-center rounded-full border border-gray-600 p-2 md:w-10 ${message.sender === "user" ? "bg-gray-700 text-white" : "bg-white"}`}
                >
                  {message.sender === "user" ? (
                    <User size={20} />
                  ) : (
                ...
                <div
                  className={`rounded-lg border border-gray-600 p-3 ${message.sender === "user" ? "bg-gray-700 text-white" : "bg-white"}`}
                >
      ...
      <motion.form
        ...
        className="absolute right-0 bottom-0 left-0 flex w-full bg-transparent p-4"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
      >
        <div className="flex w-full gap-3">
          <input
            ...
            className="w-full flex-1 rounded-lg border bg-white p-3 focus:ring-2 focus:outline-none"
          />
          <button
            type="submit"
            className="rounded-lg bg-gray-700 p-3 text-white hover:bg-gray-600 disabled:opacity-50"
